...
//   // Function to generate H3 hexagon coordinates
//   const generateHexagon = useCallback((latitude, longitude) => {
//     try {
//       const resolution = 8; // H3 resolution (0-15, higher = smaller hexagons)
//       const h3Index = h3.latLngToCell(latitude, longitude, resolution);
      
//       // Get hexagon boundary coordinates
//       const hexBoundary = h3.cellToBoundary(h3Index);
      
//       // Convert to proper format for react-native-maps Polygon
...
//       console.log("H3 Hexagon coordinates:", coordinates);
//       return coordinates;
//     } catch (error) {
//       console.error("Error generating H3 hexagon:", error);
//       return [];
//     }
//   }, []);
...
//     const hexagonCoords = generateHexagon(latitude, longitude);
//     setHexCoords(hexagonCoords);
//   }, [generateHexagon]);
...
//       // Generate H3 hexagon for the new region
...
//     }, Platform.OS === 'ios' ? 100 : 300);
//   }, [onTouchLocation, handleRegionH3ChangeComplete]);

//   // Generate initial hexagon when component mounts or origin changes
//   useEffect(() => {
//     if (mapRegion.latitude && mapRegion.longitude) {
//       const hexagonCoords = generateHexagon(mapRegion.latitude, mapRegion.longitude);
//       setHexCoords(hexagonCoords);
//     }
//   }, [mapRegion, generateHexagon]);
...
//             strokeColor={colors.primary} // Use a visible color
//             fillColor="rgba(0, 150, 255, 0.3)" // Semi-transparent blue
//             strokeWidth={2}
//           />
//         )}
//       </MapView>
...
// h-3 polygon ke liye ye code wroking hai 
...
//     }, Platform.OS === 'ios' ? 100 : 300);
//   }, [onTouchLocation, generateHexagons]);
